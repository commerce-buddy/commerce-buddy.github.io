...
export const content = {
  en: {
    ...
    pricing: {
      eyebrow: "Pricing",
      title: "One Pro license per site. 14 days free.",
      lede: "Free trial gets you the full Pro feature set. No card, no tier shuffling.",
      free: {
        name: "Free trial",
        amount: "৳ 0",
        per: "/ 14 days",
        sub: "Full Pro features. No credit card required.",
        feats: [
          "All tracking providers",
          "All courier integrations",
          "Fraud shield & blocklist",
          "Up to 5,000 events / day",
        ],
        cta: "Start free trial",
      },
      pro: {
        name: "Commerce Buddy Pro",
        ribbon: "Most popular",
        amount: "৳ 4,900",
        per: "/ year",
        strike: "৳ 7,200",
        sub: "Per WooCommerce site. Includes priority support over WhatsApp.",
        feats: [
          "Unlimited tracking events",
          "All current + future couriers",
          "Community fraud blocklist sync",
          "Priority support over WhatsApp",
          "1 year of automatic updates",
          "30-day money-back guarantee",
        ],
        cta: "Get Commerce Buddy Pro",
      },
    },
  ...
  bn: {
    ...
    pricing: {
      eyebrow: "প্রাইসিং",
      title: "প্রতি সাইটে একটা Pro লাইসেন্স। ১৪ দিন ফ্রি।",
      lede: "ফ্রি ট্রায়ালে পুরো Pro ফিচার পাচ্ছেন। কোনো কার্ড নয়, কোনো টিয়ার ঝামেলা নয়।",
      free: {
        name: "ফ্রি ট্রায়াল",
        amount: "৳ ০",
        per: "/ ১৪ দিন",
        sub: "পুরো Pro ফিচার। ক্রেডিট কার্ড লাগবে না।",
        feats: [
          "সব ট্র্যাকিং প্রোভাইডার",
          "সব কুরিয়ার ইন্টিগ্রেশন",
          "ফ্রড শিল্ড আর ব্লকলিস্ট",
          "দিনে ৫,০০০ পর্যন্ত ইভেন্ট",
        ],
      ...
      pro: {
        ...
        per: "/ বছর",
        strike: "৳ ৭,২০০",
        sub: "প্রতি WooCommerce সাইটে। WhatsApp-এ প্রায়োরিটি সাপোর্টসহ।",
        feats: [
          "আনলিমিটেড ট্র্যাকিং ইভেন্ট",
          "এখনকার + ভবিষ্যতের সব কুরিয়ার",
          "কমিউনিটি ফ্রড ব্লকলিস্ট সিঙ্ক",
          "WhatsApp-এ প্রায়োরিটি সাপোর্ট",
          "১ বছরের অটো আপডেট",
          "৩০ দিনের মানি-ব্যাক গ্যারান্টি",
        ],
        cta: "Commerce Buddy Pro নিন",
      },
    },
